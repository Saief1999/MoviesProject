 ...
 */
final class Version20200712214829 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE cinema_rating ADD my_cinema_id INT DEFAULT NULL, ADD enabled TINYINT(1) DEFAULT NULL, CHANGE cinema_id cinema_id INT DEFAULT NULL, CHANGE rating rating INT DEFAULT NULL, CHANGE name name VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE cinema_rating DROP my_cinema_id, DROP enabled, CHANGE cinema_id cinema_id INT DEFAULT NULL, CHANGE rating rating INT DEFAULT NULL, CHANGE name name VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');
