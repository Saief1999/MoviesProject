 ...
 */
final class Version20200624133125 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE movie (id INT AUTO_INCREMENT NOT NULL, movie_name VARCHAR(75) NOT NULL, release_date DATE NOT NULL, rating DOUBLE PRECISION DEFAULT NULL, run_time VARCHAR(20) DEFAULT NULL, production_companies VARCHAR(255) DEFAULT NULL, plot VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
